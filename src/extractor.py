...
def load_bosque(path: str, max_sent: int = 1000) -> List[Tuple[str, List[Dict[str, Any]]]]:
    data = []
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--n-sent-rank", type=int, default=1000)
...
if __name__ == "__main__":
    pass  # entry point moved to src/run_experiment.py
